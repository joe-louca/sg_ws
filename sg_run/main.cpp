...
int main(int argc, char* argv[])
{
	...
	ros::Publisher FingerJointAngles_pub = n.advertise<std_msgs::Float32MultiArray>("/Finger_Joint_Angles", 1);

	ros::Publisher TPdist_pub = n.advertise<std_msgs::Float32>("/TP_distance", 1);
