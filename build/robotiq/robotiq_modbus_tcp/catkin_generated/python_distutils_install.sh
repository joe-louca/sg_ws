...
echo_and_run cd "/home/joe/sg_ws/src/robotiq/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/joe/sg_ws/src/robotiq/robotiq_modbus_tcp/setup.py" \
     \
    build --build-base "/home/joe/sg_ws/build/robotiq/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
