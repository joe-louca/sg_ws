...
class SG_CONTROL:
    ...
    def __init__(self):
        ...
        model = mujoco.MjModel.from_xml_path(path_to_models + 'myscenes/allegro_left.xml')
        ...
        while not rospy.is_shutdown():
            ...
            if self.received_sg_cmd_:
                ...
                # TESTING
                #data.ctrl[18] = math.sin(frm*math.pi/180)
                #if frm % 100 > 50:
                #    data.ctrl[15] = 10*math.pi/180
                #else:
                #    data.ctrl[15] = 0*math.pi/180
