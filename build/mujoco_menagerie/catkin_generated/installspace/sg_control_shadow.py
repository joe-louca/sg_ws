...
class SG_CONTROL:
    ...
    def __init__(self):
        ...
        self.received_cmd_ = False
        
        rospy.init_node('sg_MJC_controller', anonymous=True)
        t0 = rospy.get_time()
        pub = rospy.Publisher('/FingerContacts', Float32MultiArray, queue_size=1)
        sub = rospy.Subscriber('/Delayed_FingerJointAngles', Float32MultiArray, self.callback, queue_size=1)
        rate_hz = 200
        ...
        model = mujoco.MjModel.from_xml_path(path_to_models + 'shadow_hand/scene_left.xml')
